...
def set_camera(rho, theta, phi=0, look_at=(0, 0, 0), jitter=0):
    ...
    # get directions
    directions = {}
    bpy.ops.mesh.primitive_plane_add(size=10)  # plane added for computing cardinal directions  # TODO: CHECK BLENDER API: we *think* size = 2 * radius
    plane = bpy.context.object

    # TODO: CHECK BLENDER API: sigh, are there any cases where they used * and it works
